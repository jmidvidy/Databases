...
"<br><br><h1>Historic Performance:</h1>"+
"<p>Below is the historic performance for "+ symbol +" over the " + interval  + ".</p>"+
"</div>")
print "</div>" 
...
vals = stockAPI.getHistoricInfo(symbol, interval) 
print "<div id=\"hidden-vals\" style=\"display:none \">"
print ",".join(vals)
print "</div>"

chartBody = "<div id=\"chartDiv\"></div>"
chartCard = generateCardWithBody("card bg-light", "Historic Performance:", "", chartBody)
print chartCard   
print "</div>"
